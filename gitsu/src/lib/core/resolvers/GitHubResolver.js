...
GitHubResolver.prototype._savePkgMeta = function (meta, dir, gitsuName, skipWrite) {
    // Set homepage if not defined
    if (!meta.homepage) {
        meta.homepage = 'https://github.com/' + this._org + '/' + this._repo;
    }

    return GitRemoteResolver.prototype._savePkgMeta.call(this, meta, dir, gitsuName, skipWrite);
};
