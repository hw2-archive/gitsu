...
GitRemoteResolver.prototype._savePkgMeta = function (meta, dir, gitsuName, skipWrite) {
    return GitResolver.prototype._savePkgMeta.call(this, meta, dir, this._updatedDirectly ? ".gitsu.json.new" : gitsuName, skipWrite);
};
