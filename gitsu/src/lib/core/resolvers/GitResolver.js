...
//var HWCore = require("hwcore/modules/js/src/kernel")().inst;
...
GitResolver.prototype._savePkgMeta = function (meta, dir, gitsuName, skipWrite) {
    var version;
    ...
    return Resolver.prototype._savePkgMeta.call(this, meta, dir, gitsuName, skipWrite);
};
