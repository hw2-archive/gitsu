...
//      in environments without module system
    ...
    pub.setPaths = function (root, core) {
        ...
        this.defines.PATH_CORE = core || root + "hw-core/";
        this.defines.PATH_JS_KERNEL = this.defines.PATH_CORE + "js-kernel/";
        this.defines.PATH_JS_LIB_PREFIX = this.defines.PATH_JS_SRC + "library/";
    };
